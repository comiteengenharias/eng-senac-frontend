...
export default function Projects() {
    ...
    const projects = [
...

        {
            ...
            text: [
                "Alunos do 4° semestre desenvolveram um sistema integrado de automação voltado para processos logísticos e empresariais, utilizando dispositivos de leitura de código de barras para otimizar o controle de estoque e rastreamento de produtos.",
