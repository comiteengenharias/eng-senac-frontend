...
import "../cadastro.css";
import { postMemberRegistration } from "@/services/api-register";
import { useRouter } from 'next/navigation';
import { loginStudent, logout, verifyLogin } from '@/services/api-login';
...
export default function AreaRestrita() {
  ...
  const sendData = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const formDataObj = {
      ...
      groupToken: formData.get('group-token') as string
    };
            ...
            <div className="hidden lg:flex col-span-1 relative bg-gradient-to-br from-[#0066cc] to-[#0052a3] rounded-l-2xl items-center justify-center">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-black/30 to-black/50 flex items-end p-6">
                <div className="text-white">
                  <h3 className="text-2xl font-bold mb-2">Junte-se ao seu projeto</h3>
                  <p className="text-blue-100 text-sm">Integre-se a um projeto já existente na Semana das Engenharias</p>
                </div>
              </div>
            </div>
