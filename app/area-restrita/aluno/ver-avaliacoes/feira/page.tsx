...
export default function AreaRestrita_Aluno() {
    ...
    const assessments = [
        ...
        {
            appraiser: "Rafael Pequino Freire - 4º sem",
            image: "/img/pictures/user.jpg",
            coment: "'Muito bom'",
        },
    ];
    ...
    return (
        <div>
            ...
            <main className="sm:ml-[250px] mt-16 min-h-[calc(100vh-64px)] bg-[var(--gray)]">
                ...
                <div className="p-6">
                    <h2 className="mb-6 border-b">Avaliações docentes</h2>
                    ...
                    <h2 className="mb-6 border-b">Avaliações discentes</h2>
