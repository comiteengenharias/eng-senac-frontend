  ...
  return (
    <main className="min-h-screen bg-[#f4f7fc] text-[#032048]">
      ...
      <section className="relative overflow-hidden border-b-2 border-[#173b6e]">
        <Image
          src="/img/pictures/robotica-hero.jpg"
          alt="Time de robótica"
          width={1920}
          height={1080}
        ...
        <div className="absolute inset-0 mx-auto grid h-full w-full max-w-7xl items-end px-4 pb-12 pt-16 lg:grid-cols-[1fr_340px] lg:items-center lg:px-8">
          <div>
            ...
            <h1 className="text-3xl font-black uppercase leading-[0.95] text-white sm:text-4xl md:text-6xl">
              Desafio prático de Engenharia e TI
              <span className="mt-3 block text-[#22e1ff] italic">Transformação digital em serviços</span>
            </h1>
            <p className="mt-6 max-w-2xl text-sm text-white/85 sm:text-base md:text-xl">
              9ª edição do Torneio de Robótica do Centro Universitário Senac, atividade pedagógica, científica e cultural com foco em resolução de problemas, autonomia e desenvolvimento de competências técnicas.
            </p>
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
              <Link href="/robotica/login/" className="inline-flex justify-center bg-[#14d9ff] px-8 py-4 text-sm font-extrabold uppercase tracking-[0.18em] text-[#052452] transition hover:bg-[#34e4ff]">
                Inscrever equipe
              </Link>
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-10 md:grid-cols-[1.4fr_1fr_1fr_1fr] lg:px-8">
          <div>
            ...
            <div className="mt-6 flex gap-3">
              <a
                href="#"
                className="flex h-10 w-10 items-center justify-center border border-[#1f3d65] text-xs font-bold text-[#d6e5fb] transition hover:border-[#2f5689] hover:text-white"
